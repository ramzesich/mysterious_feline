const levelObjects = [
    ...
    { type: 'arrow', x: 450, arrowType: 'right', height: 120 }, // High floating "Go Right" guidance
    { type: 'spike', x: 550, width: 30, height: 15 },
    { type: 'pillar', x: 750, width: 40, height: 60 },
    { type: 'arrow', x: 900, arrowType: 'up', height: 50 },    // Points up toward the floating shelves
    ...
    // Zone 2: The Deep Gauntlet & Battery Cache (2000px - 4000px)
    { type: 'platform', x: 2100, width: 120, height: 90 },
    { type: 'battery', x: 2150, height: 115 }, // Hidden midway point reward
    
    { type: 'pillar', x: 2400, width: 40, height: 90 },
    { type: 'arrow', x: 2550, arrowType: 'up', height: 60 },   // Signals trick jump ahead
    ...
    // Zone 3: The Deep Core Outpost (4000px - 8000px)
    { type: 'arrow', x: 4000, arrowType: 'right', height: 100 },
    ...
    { type: 'arrow', x: 5800, arrowType: 'right', height: 120 },
